...
@section('title', 'Tambah Intervensi')
            ...
            <div class="card mb-4">
                ...
                <div class="card-body p-3">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control form-control-alternative" id="content" name="content" placeholder="Content">{{ old('content') }}</textarea>
                    </div>
                </div>
